 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ue{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(r=>{if(Ve(r)){const s=r.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(r=>r).join(" ")}}function Ve(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const R="@firebase/app",z="0.9.28";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ot(t){L(new I("platform-logger",e=>new Ue(e),"PRIVATE")),L(new I("heartbeat",e=>new St(e),"PRIVATE")),v(R,z,t),v(R,z,"esm2017"),v("fire-js","")}Ot("");var Bt="firebase",Tt="10.8.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */v(Bt,Tt,"app");export{I as C,Q as E,b as F,Te as L,Gt as S,L as _,$t as a,Lt as b,zt as c,Wt as d,ue as e,Jt as f,Mt as g,Pt as h,Et as i,Vt as j,T as k,h as l,X as m,Ut as n,ae as o,xt as p,kt as q,v as r,jt as s,Ft as t,Nt as u,Rt as v,Ht as w,me as x};
